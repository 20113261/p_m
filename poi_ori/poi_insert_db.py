...
if __name__ == '__main__':
    ...
    # cids = [10001, 10002, 10003, 10004, 10005, 10006, 10009, 10010, 10011, 10012, 10015, 10016, 10017, 10019, 10020,
    #         10025, 10027, 10036, 10037, 10042, 10043, 10045, 10046, 10047, 10048, 10053, 10054, 10055, 10058, 10063,
    #         10065, 10068, 10069, 10073, 10078, 10086, 10090, 10092, 10100, 10101, 10105, 10115, 10117, 10118, 10121,
    #         10123, 10126, 10149, 10156, 10168, 10171, 10223, 10261, 10268, 10283, 10290, 10319, 10341, 10357, 10361,
    #         10365, 10373, 10387, 10414, 10422, 10487, 10494, 10554, 10680, 10729, 10872, 10932, 11095, 11098, 11100,
    #         11221, 11635, 11799, 12274, 12318, 12411, 12421, 12467, 12561, 13224, 20069, 20070, 20071, 20078, 20082,
    #         20100, 20148, 20150, 20186, 20213, 20371, 20384, 20409, 20414, 20454, 20601, 20757, 20956, 21257, 21334,
    #         21479, 40002, 40050, 40052, 50012, 50016, 50030, 50106, 50734, 50738, 51346, 60001, 60005, 60009, 60027,
    #         60097]

    # cids = [10002]
    for city_id in cids:
        poi_insert_data(city_id, 'shop')
