# coding=utf-8
'''
    @desc:      tripadvisor生成图片对应关系，然后rename。图片，source_id和miaoji_id的对应关系 >> 入库：file_name,sid,url,bucket_name,size,md5_name
'''
...
import os
import configparser
from . import is_complete_scale_ok as img_filter  # 图片过滤程序
